...
def serve_focus(
    ...
    fig_1 = go.Figure(data=[
        go.Bar(name='Indéterminé', x=serve_grade_ratios_df.index, y=serve_grade_counts_df['undetermined_count'], marker_color=grade_color_dict['undetermined']),
        go.Bar(name='Faute service', x=serve_grade_ratios_df.index, y=serve_grade_counts_df['error_count'], marker_color=grade_color_dict['serve error']),
        go.Bar(name='Réception parfaite (++)', x=serve_grade_ratios_df.index, y=serve_grade_counts_df['excellent_pass_count'], marker_color=grade_color_dict['excellent pass (++)']),
        go.Bar(name='Bonne réception (+)', x=serve_grade_ratios_df.index, y=serve_grade_counts_df['good_pass_count'], marker_color=grade_color_dict['good pass (+)']),
        go.Bar(name='Réception moyenne (0)', x=serve_grade_ratios_df.index, y=serve_grade_counts_df['average_pass_count'], marker_color=grade_color_dict['average pass (0)']),
        go.Bar(name='Mauvaise réception (-)', x=serve_grade_ratios_df.index, y=serve_grade_counts_df['bad_pass_count'], marker_color=grade_color_dict['bad pass (-)']),
        go.Bar(name='Ace', x=serve_grade_ratios_df.index, y=serve_grade_counts_df['ace_count'], marker_color=grade_color_dict['ace'])
    ])
    fig_1.update_layout(
        barmode='stack',
    ...
    # Columns set up
    col_selectbox, col_widget_1, col_widget_2, col_widget_3 = st.columns([1, 0.5, 0.5, 0.5])
    ...
    with col_selectbox:
        ...
        focus_game_ids = results_df[results_df['paire_name'] == selected_opponent_paire_name]['game_id'].unique()
