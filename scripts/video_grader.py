...
class VideoGrader:
    ...
    def service_passing_grading(
        ...
        for point_id in points_ids:
            ...
            action_grades, quit_grading, new_keys_colors_index, new_grades_color_index = basic_action_grader(
                ...
                keys_colors_index=keys_colors_index,
                grades_color_index=grades_color_index,
            )
            # Updating the color indexes for the next grading iteration to keep 
            # the same colors for the same keys and grades across the grading session
            keys_colors_index = new_keys_colors_index
            grades_color_index = new_grades_color_index
